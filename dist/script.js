...
/***/ "./src/js/modules/accordionTwo.js":
/*!****************************************!*\
  !*** ./src/js/modules/accordionTwo.js ***!
  \****************************************/
...
var accordionTwo = function accordionTwo(triggersSelector) {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = "Пожалуйста выберите размер и материал картини";
...
var drop = function drop() {
  ...
  ['dragenter', 'dragover', 'dragover', 'drop'].forEach(function (eventName) {
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Errow("Could not #{url}, status: ".concat(res.status));
